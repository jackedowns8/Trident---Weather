$( document ).ready(function() {
    ...
    var ctx1 = document.getElementById("tidesChart").getContext("2d");
    var data1 = {
        labels: ["9:00am", "11:11am", "4:04pm", "10:52pm"],
        datasets: [
            {
                label: "Tides",
                fillColor: "#ffffff",
    ...
    var tidesChart = new Chart(ctx1).LineAlt(data1, {
        scaleShowGridLines : true,
        scaleFontColor: "#ffffff",
        scaleFontFamily: "Roboto-Thin",
